    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-8 overflow-auto pb-10">
                    <div id="printable-contract">
                        {/* Page 1 */}
                        <div className="contract-page page-1 flex flex-col items-center">
                            ...
                            <div className="contract-header uppercase mb-8 mt-4 w-full text-center">CONTRATO DE PRESTAÇÃO DE SERVIÇOS</div>

                            <div className="contract-body space-y-4 px-2 w-full text-justify">
                        ...
                        {/* Page 2 */}
                        <div className="contract-page page-subsequent">
                            <div className="contract-body space-y-4 px-2 w-full text-justify">
                        ...
                        <div className="contract-page page-subsequent">
                            <div className="contract-body space-y-4 px-2 w-full text-justify">
                                ...
                                <p>4.1 – O presente contrato poderá ser rescindido imotivadamente a qualquer tempo pelas partes, mediante comunicação escrita á outra parte, com antecedência mínima de 30 (trinta) dias, sem acarretar ônus para ambas as partes.</p>
                        ...
                        <div className="contract-page page-subsequent">
                            <div className="contract-body space-y-4 px-2 w-full text-justify">
                                ...
                                <p>8.5 – Toda e qualquer alteração pertinente ao contrato deverá ser informada imediatamente á outra parte, assim que de sua ocorrência, sob pena de ser responsabilizada a parte a quem cabia esta obrigação pelos prejuízos acarretados decorrentes desse atraso.</p>
            ...
            <style dangerouslySetInnerHTML={{
                ...
                .page-1 {
                    padding: 1.5cm 2.5cm 1cm 2.5cm;
                }

                .page-subsequent {
                    padding: 6cm 2.5cm 2.5cm 2.5cm;
                }
