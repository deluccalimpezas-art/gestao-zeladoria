                                        ...
                                        {isManualMode ? (
                                            ...
                                            <div id="contract-content-area">
                                                ...
                                                <div className="contract-body space-y-4 px-0 pb-10">
                                                    ...
                                                    <div className="page-break-container text-right mt-6 mb-24 avoid-break">
                                                        <span className="font-bold italic">{contractorCity}, {getDateExtenso(signatureDateObj)}.</span>
                                                    </div>

                                                    {/* Signatures */}
                                                    <div className="grid grid-cols-2 gap-16 text-center text-sm mt-16 mb-12 px-4 avoid-break">
