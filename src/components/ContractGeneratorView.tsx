                                        ...
                                        {isManualMode ? (
                                            ...
                                            <div id="contract-content-area">
                                                ...
                                                <div className="contract-body space-y-4 px-0">
                                                    ...
                                                    <p>2.11 – Deverá comunicar-se com a CONTRATANTE always que ocorrer alguma anormalidade que possa prejudicar o atendimento das cláusulas deste contrato, ou a prestação dos serviços de acordo com o estabelecido.</p>
