            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-8 overflow-auto pb-10">
                    <div id="printable-contract" className="bg-white text-black mx-auto shadow-2xl printable-area">
                        {/* professional Logo */}
                        <div className="flex flex-col items-center pt-0 mb-12">
                            <div className="flex items-baseline gap-0">
                                <span className="text-7xl font-black text-[#FFD700] tracking-tighter font-serif">De</span>
                                <span className="text-7xl font-black text-[#00CEE4] tracking-tighter font-sans">Lucca</span>
                            </div>
                            <div className="text-[32px] text-[#00CEE4] -mt-4 italic" style={{ fontFamily: "'Dancing Script', cursive", textShadow: '0.5px 0.5px 0px rgba(0,0,0,0.1)' }}>
                                Gestão em Limpeza
                            </div>
                        </div>

                        <div className="contract-header uppercase mb-12">CONTRATO DE PRESTAÇÃO DE SERVIÇOS</div>
                        ...
                        <div className="contract-body space-y-6">
                            ...
                            <h4 className="font-bold text-center mt-12 uppercase underline decoration-1 underline-offset-4">Cláusula 1ª – DO OBJETO</h4>
                            ...
                            <div className="pl-8 space-y-2">
                                <p>a) Manutenção de Ambientes: Organização e conservação de áreas comuns, incluindo salas, corredores, banheiros, áreas externas, academias, salões de festa, elevadores, escadarias, garagens, halls internos, hall de entrada, sauna, salão de jogos, espaço gourmet, área de funcionários, depósitos, calçadas, cozinhas e a reposição de suprimentos (como papel toalha, sabonete, etc.).</p>
                                <p>b) Limpeza de Equipamentos: Higienização e limpeza dos móveis das áreas de lazer, do hall de entrada e dos equipamentos instalados nas áreas comuns.</p>
                                <p>c) Limpeza de Eletrodomésticos: Limpeza interna e externa de eletrodomésticos, incluindo geladeiras, micro-ondas, fogões, e demais equipamentos, garantindo a manutenção da higiene e funcionamento adequado.</p>
                                <p>d) Coleta de Lixo: Recolhimento, separação e destinação adequada de resíduos.</p>
                            </div>

                            <h4 className="font-bold text-center mt-12 uppercase underline decoration-1 underline-offset-4">Cláusula 2ª – DAS CONDIÇÕES DA PRESTAÇÃO DE SERVIÇOS</h4>
                            <p className="font-bold text-center mt-6">ITEM I – OBRIGAÇÕES DA CONTRATANTE</p>
                            ...
                            <p className="font-bold text-center mt-6">ITEM II – OBRIGAÇÕES DA CONTRATADA</p>
                            ...
                            <p>2.16 – O Preposto terá a obrigação de se reportar, when necessário, ao responsável pelo acompanhamento dos serviços da CONTRATANTE e de tomar as providências pertinentes para que sejam corrigidas todas as falhas detectadas.</p>
                            ...
                            {serviceType === '22h' ? (
                                <div className="ml-8 whitespace-pre-wrap leading-relaxed">
                            ...
                            <h4 className="font-bold text-center mt-12 uppercase underline decoration-1 underline-offset-4">ITEM III – SERVIÇOS E SUAS EXECUÇÕES</h4>
                            ...
                            <p>2.30 – A CONTRATANTE poderá suspender os pagamentos ou a execução dos serviços, em virtude de inadimplemento, pelo CONTRATADO, de qualquer cláusula ou condition deste contrato.</p>
                            ...
                            <h4 className="font-bold text-center mt-12 uppercase underline decoration-1 underline-offset-4">Cláusula 3ª – DO PREÇO E DAS CONDIÇÕES DE PAGAMENTO</h4>
                            {serviceType === '22h' ? (
                            ...
                            <h4 className="font-bold text-center mt-12 uppercase underline decoration-1 underline-offset-4">Cláusula 4ª – DA RESCISÃO</h4>
                            ...
                            <div className="pl-8 space-y-2">
                                <p>a) Descumprimento das obrigações ajustadas por quaisquer das PARTES, se não sanado o inadimplemento dentro de 5 (cinco) dias, a contar da data do recebimento de notificação escrita pela parte prejudicada;</p>
                                <p>b) Na hipótese de insolvência, falência, recuperação judicial ou extrajudicial ou ação semelhante, ou de resolução para dissolução ou liquidação judicial, de qualquer das PARTES;</p>
                                <p>c) Encerramento da atividade, venda, cessão de direitos, alteração societária, não aprovação do plano de recuperação e deferimento de falência da CONTRATADA; e</p>
                                <p>d) Condenação trabalhista da CONTRATADA em primeira instância decorrente de reclamação trabalhista proposta por seus funcionários e que prestem ou prestaram serviços nas dependências do CONTRATANTE, sendo que, neste caso, é facultado a este último reter o pagamento das faturas, limitada a três, até que haja a satisfação da obrigação.</p>
                            </div>
                            ...
                            <h4 className="font-bold text-center mt-12 uppercase underline decoration-1 underline-offset-4">Cláusula 5ª – DO PRAZO E DA VALIDADE</h4>
                            ...
                            <h4 className="font-bold text-center mt-12 uppercase underline decoration-1 underline-offset-4">Cláusula 7ª – DA AUSÊNCIA DE VÍNCULO TRABALHISTA</h4>
                            ...
                            <h4 className="font-bold text-center mt-12 uppercase underline decoration-1 underline-offset-4">Cláusula 8ª – DISPOSIÇÕES GERAIS</h4>
                            ...
                            <p className="mt-8">E, por estarem assim, justas e contratadas, CONTRATANTE E CONTRATADO assinam o presente instrumento em 2 (duas) vias de igual teor e forma para a produção de todos os efeitos de direito.</p>
                            ...
                            {/* Signatures */}
                            <div className="grid grid-cols-2 gap-24 text-center text-sm mb-24 px-4">
