...
import { Upload, DollarSign, TrendingUp, TrendingDown, Percent, Activity, Users, Building, ArrowRight, CalendarDays, Trash2, Copy, Plus, ArrowUpRight, ArrowDownRight, Minus } from 'lucide-react';
